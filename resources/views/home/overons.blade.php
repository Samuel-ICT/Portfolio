            ...
            <div class="flex flex-wrap ">
                <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                    <div class="relative lg:max-w-md">
                        ...
                        <div
                            class="absolute bottom-0 right-0 z-10 p-8 bg-white border-4 border-indigo-500 rounded shadow lg:-mb-8 lg:-mr-11 sm:p-8 ">
                            <p class="text-lg font-semibold md:w-72">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    class="absolute top-0 left-0 w-16 h-16 text-indigo-700 opacity-10"
                                    viewBox="0 0 16 16">
                                    <path
