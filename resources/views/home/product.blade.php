        ...
        <div class="flex flex-col space-y-8 md:w-1/2">
            ...
            <div class="md:mx-8 shadow-lg px-2">
                ...
                <form action="{{url('kart',$product->id)}}" method="post">
                    ...
                    <button type="submit" class="text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-md px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800 mt-8 mb-4">
