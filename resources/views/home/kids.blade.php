        ...
        <div class="max-w-6xl px-5 mx-auto mt-28 text-center">
            <div class="grid md:grid-cols-4 gap-6 sm:grid-cols-2 gap-6">
                @foreach($kids as $producten)
                    <!-- Productdetails -->
                    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow hover:border-indigo-600 dark:border-gray-700">
                        ...
                        <div class="px-5 pb-5">
                            ...
                            <a href="{{url('product', $producten->slug)}}">
                                <h5 class="text-lg font-semibold tracking-tight text-gray-900 dark:text-black mt-2">{{$producten->naam}}</h5>
                            </a>
                            ...
                            <div class="flex items-center mt-2.5 mb-5">
                                ...
                                <span class="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-3">4.3</span>
                            </div>
                            <!-- Prijsinformatie -->
                            <div class="flex items-center justify-between">
                                <!-- Gereduceerde prijs als er korting is -->
                                @if($producten->korting_prijs!=null)
                                <span class="text-3xl font-bold text-gray-900 dark:text-black">€{{$producten->korting_prijs}}</span>
