                ...
                <div
                    ...
                    <div class="px-5 pb-5">
                        ...
                        <div class="flex items-center mt-2.5 mb-5">
                            ...
                            <span
                                class="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded ms-3">4.3</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <!-- Prijsinformatie -->
                            @if($product->korting_prijs!=null)
                            <span
                                class="text-3xl font-bold text-gray-900 ">€{{$product->korting_prijs}}</span>
                            <span
