            ...
            <div class="grid md:grid-cols-4 gap-6 sm:grid-cols-2 gap-6">
                ...
                <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow hover:border-indigo-600 dark:border-gray-700">
                    ...
                    <div class="px-5 pb-5">
                        <!-- Productnaam -->
                        <a href="{{url('product', $product->slug)}}">
                            <h5 class="text-lg font-semibold tracking-tight text-gray-900 dark:text-black mt-2">{{$product->naam}}</h5>
                        </a>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <!-- Prijs met korting -->
                            <span class="text-3xl font-bold text-gray-900 dark:text-black ">€{{$product->korting_prijs}}</span>
