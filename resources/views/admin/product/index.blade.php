...
<body class="bg-black">
    ...
    <div class="p-10 sm:ml-64">
        ...
        @if(session('message'))
        <div id="alert-3" class="flex items-center mt-5 p-4 mb-4 text-green-800 rounded-lg bg-green-50" role="alert">
        ...
        <table class="text-sm text-left text-gray-500">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <!-- Bewerkknop -->
                    <td class="px-6 py-4">
                        <a href="{{url('admin/product/bewerken',$product->id)}}" class="font-medium text-blue-600 hover:underline">Bewerken</a>
                    </td>
                    <!-- Verwijderknop met bevestiging -->
                    <td class="px-6 py-4">
                        <a href="{{url('admin/product/verwijderen',$product->id)}}" onclick="return confirm('Ben je zeker of je dit wilt verwijderen?')" class="font-medium text-red-600 hover:underline ">Verwijderen</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
