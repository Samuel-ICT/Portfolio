...
<body class="bg-black">
    ...
    <section>
        ...
        <div id="alert-3" class="flex items-center mt-5 p-4 mb-4 ml-64 text-green-800 rounded-lg bg-green-50" role="alert">
            ...
            <table class="text-sm text-left text-gray-500">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ url('admin/contact/verwijderen', $bericht->id) }}" onclick="return confirmDelete();" class="font-medium text-red-600 hover:underline">Verwijderen</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
