                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <a href="{{url('admin/users/verwijderen',$user->id)}}" onclick="return confirm('Ben je zeker of je dit wilt verwijderen?')" class="font-medium text-red-600 hover:underline">Verwijderen</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
